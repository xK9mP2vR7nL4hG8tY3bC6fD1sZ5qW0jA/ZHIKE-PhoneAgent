...
const getInitialCollapsedState = (): boolean => {
  try {
    const saved = localStorage.getItem('zhike-phoneagent-sidebar-collapsed');
...
const getInitialSidebarWidth = (): number => {
  try {
    const saved = localStorage.getItem('zhike-phoneagent-sidebar-width');
    if (saved !== null) {
...
export function DeviceSidebar({
  ...
  useEffect(() => {
    localStorage.setItem(
      'zhike-phoneagent-sidebar-collapsed',
  ...
  useEffect(() => {
    localStorage.setItem(
      'zhike-phoneagent-sidebar-width',
      String(sidebarWidth)
    );
  }, [sidebarWidth]);
