...
from zhike_phoneagent.agents.protocols import AsyncAgent
...
from zhike_phoneagent.prompt_config import get_messages, get_system_prompt
            ...
            with trace_span(
                ...
                try:
                    ...
                    error_details = await serialize_model_error_async(
                        ...
                        call_site="zhike_phoneagent.agents.glm.async_agent.AsyncGLMAgent._stream_openai",
                    )
