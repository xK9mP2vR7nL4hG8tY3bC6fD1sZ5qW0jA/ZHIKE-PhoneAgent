...
if TYPE_CHECKING:
    from zhike_phoneagent.device_manager import ManagedDevice
...
def _build_device_response_with_agent(
    ...
    """
    from zhike_phoneagent.device_group_manager import device_group_manager
...
def discover_mdns() -> MdnsDiscoverResponse:
    ...
    from zhike_phoneagent.adb_plus import discover_mdns_devices
...
def delete_device_group(group_id: str) -> DeviceGroupOperationResponse:
    """删除设备分组（设备移回默认分组）."""
    from zhike_phoneagent.device_group_manager import device_group_manager
    from zhike_phoneagent.models.device_group import DEFAULT_GROUP_ID
