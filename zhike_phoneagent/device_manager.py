...
from zhike_phoneagent.adb import ADBConnection, ConnectionType, DeviceInfo
from zhike_phoneagent.logger import logger
from zhike_phoneagent.types import DeviceConnectionType

from zhike_phoneagent.device_protocol import AsyncDeviceProtocol, DeviceProtocol
...
def map_adb_connection_type_to_device_connection_type(
    ...
    In ``zhike_phoneagent.adb.connection``, ``ConnectionType.REMOTE`` means an ADB
...
class DeviceManager:
    ...
    def __init__(self, adb_path: str = "adb"):
        ...
        from zhike_phoneagent.device_metadata_manager import DeviceMetadataManager
    ...
    def _check_mdns_support(self) -> bool:
        ...
        if self._mdns_supported is None:
            from zhike_phoneagent.adb_plus.version import supports_mdns_services
    ...
    def _poll_devices(self) -> None:
        ...
        from zhike_phoneagent.adb_plus import get_device_serial
        ...
        if self._enable_mdns_discovery and self._check_mdns_support():
            from zhike_phoneagent.adb_plus import (
    ...
    def connect_wifi(
        ...
        """
        from zhike_phoneagent.adb import ADBConnection, ConnectionType

        from zhike_phoneagent.adb_plus import get_wifi_ip
    ...
    def pair_wifi(
        ...
        from zhike_phoneagent.adb_plus import pair_device
    ...
    def discover_remote_devices(
        ...
        """
        from zhike_phoneagent.devices.remote_device import RemoteDeviceManager
    ...
    def _ensure_adb_keyboard_once(
        ...
        try:
            from zhike_phoneagent.adb_plus import ADBKeyboardInstaller
    ...
    def get_async_device_protocol(
        ...
        from zhike_phoneagent.devices.adb_device import AsyncADBDevice
