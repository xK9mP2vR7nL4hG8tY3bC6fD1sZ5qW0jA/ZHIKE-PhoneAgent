...
import zhike_phoneagent.agents as agents_module
import zhike_phoneagent.agents.factory as factory
...
from zhike_phoneagent.devices.mock_device import MockDevice, MockDeviceManager
...
def _patch_task_tracing(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "zhike_phoneagent.task_manager.record_trace_latency_metrics",
        lambda **kwargs: None,
    )
...
def test_mock_and_remote_devices() -> None:
    ...
    import zhike_phoneagent.devices.remote_device as remote_module
